# Release checklist: Guilded 3.1.0
...
- [x] Tests (314), addon validator and type check pass; `dist/Guilded-v3.1.0.zip` and the companion installer built.
...
- [ ] **CurseForge:** upload `dist/Guilded-v3.1.0.zip` as **Beta**, paste the changelog from `docs/CURSEFORGE_COPYPASTE.md`. If 3.0.1 was never uploaded, mention the rename.
