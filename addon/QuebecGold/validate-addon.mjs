...
const addonFiles = ["Core.lua", "Compat.lua", "Locale.lua", "Standings.lua", "Modules/Casino.lua", "Modules/Sync.lua", "Modules/Sim.lua", "Modules/Bidding.lua", "Modules/Calendar.lua", "Modules/Consumables.lua", "Modules/Digest.lua", "Modules/Dungeon.lua", "Modules/Minimap.lua"];
