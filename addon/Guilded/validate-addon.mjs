...
const addonFiles = ["Core.lua", "Compat.lua", "Locale.lua", "Standings.lua", "Modules/Games.lua", "Modules/Sync.lua", "Modules/Sim.lua", "Modules/Bidding.lua", "Modules/Council.lua", "Modules/Reserve.lua", "Modules/Recipes.lua", "Modules/Calendar.lua", "Modules/ConsumableData.lua", "Modules/Consumables.lua", "Modules/Digest.lua", "Modules/API.lua", "Modules/Backup.lua", "Modules/SyncNow.lua", "Modules/AutoInvite.lua", "Modules/Dungeon.lua", "Modules/Attunements.lua", "Modules/Ready.lua", "Modules/Minimap.lua"];
