...
local MODULE_ALIASES = { casino = "games", game = "games", bid = "bidding", bids = "bidding", gp = "bidding", lc = "council", lootcouncil = "council", dungeons = "dungeon", test = "sim", tests = "sim", consumable = "consumables", consumes = "consumables", flask = "consumables" }
