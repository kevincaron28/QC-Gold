...
Version 3.0.2 (public release): see CHANGELOG.md. To publish the addon on CurseForge see docs/RELEASE_CURSEFORGE.md; the day-of checklist is TODAY_TODO.md. The companion has a desktop app (`companion-app/`).
