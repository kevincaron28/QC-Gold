# Today: ship v3.0.2 to CurseForge
...
Install: copy `addon\Guilded\` (or unzip `dist\Guilded-v3.0.2.zip` after
`npm run addon:zip`) into `Interface\AddOns\`, restart the game.

- [x] (login OK 2026-09-26: Identity Ray / Classic Beta PvP matches the companion realm, no diagnostics, first /reload uploads reached the bot) Login: no error popup, no "blocked action". `/guilded version` says 3.0.2.
...
- [ ] Create the CurseForge project, paste the description from
      docs/RELEASE_CURSEFORGE.md, upload `dist/Guilded-v3.0.2.zip` as **Beta**,
      paste the 3.0.2 changelog.
